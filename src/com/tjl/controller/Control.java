...
//				添加用户
			...
			case 2:
//				删除用户
				String phone = View.deleteMenuView();
				flag = managerDao_Imp.delete(phone);
...
//				查询用户信息
				...
				do {
					...
					case 0:
						...
						break;
					case 1:
						String academy = View.select();
						User selectedUser = managerDao_Imp.select(academy);
						break;
					case 2:
